...
class JPKTransfer(models.Model):
    ...
    name = fields.Char(track_visibility='onchange', required=1)
    ...
    error_description = fields.Text(track_visibility='onchange')
    reference_number = fields.Char(track_visibility='onchange')
    state = fields.Selection([('draft', _('Draft')),
                              ('to_sign', _('To Sign')),
                              ('sent', _('Sent to IRS')),
                              ('confirmed', _('Confirmed')),
                              ('declined', _('Declined'))], default='draft', required=1, readonly=1,
                             group_expand='get_all_stages', track_visibility='onchange')
